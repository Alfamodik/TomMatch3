...
public class LevelMakerEditor : EditorWindow
{
    ...
    void GUIAds()
    {
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        unityAdsSettings.unityRewardedAndroid = EditorGUILayout.TextField("Unity Rewarded Android", unityAdsSettings.unityRewardedAndroid , new GUILayoutOption[] {
            GUILayout.Width (220),
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        unityAdsSettings.unityRewardedIOS = EditorGUILayout.TextField("Unity Rewarded iOS", unityAdsSettings.unityRewardedIOS, new GUILayoutOption[] {
            GUILayout.Width (220),
            GUILayout.MaxWidth (300)
        });
        GUILayout.EndHorizontal();
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        unityAdsSettings.unityInterstitialAndroid = EditorGUILayout.TextField("Unity Interstitial Android", unityAdsSettings.unityInterstitialAndroid, new GUILayoutOption[] {
            GUILayout.Width (220),
            GUILayout.MaxWidth (300)
        });
        GUILayout.EndHorizontal();
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        unityAdsSettings.unityInterstitialIOS = EditorGUILayout.TextField("Unity Interstitial iOS", unityAdsSettings.unityInterstitialIOS, new GUILayoutOption[] {
            GUILayout.Width (220),
            GUILayout.MaxWidth (300)
        });
    ...
    void GUIHelp()
    {
        GUILayout.Label("Jelly Garden Match 3 Complete Project + EDITOR v "+ Application.version, EditorStyles.boldLabel, new GUILayoutOption[] { GUILayout.Width(400) });
    ...
    void GUISettings()
    {
        ...
        if (score_settings)
        {
            ...
            lm.scoreForIngredients = EditorGUILayout.IntField("Score for ingredients ", lm.scoreForIngredients, new GUILayoutOption[] {
                GUILayout.Width (50),
                GUILayout.MaxWidth (200)
            });
            GUILayout.Space(10);
